...
if __name__ == '__main__':
    ...
    folder_textdoc_path = 'C:/Users/kaurm/Desktop/OCR/Navy-Federal-Project/Data/June/MoneyTransferApps/Textfiles'
    ...
    with open('june_money_transfer_apps'+'.csv','w', newline='', encoding='utf-8') as f1:
        ...
        for text_doc in textdoc_paths:
            try:
                ...
                del_file = 'C:/Users/kaurm/Desktop/OCR/Navy-Federal-Project/Data/June/MoneyTransferApps/Textfiles/' + file_name
                os.remove(del_file)
                picture_file = file_name[0:-3] + "jpg"
                the_picture_file = "C:/Users/kaurm/Desktop/OCR/Navy-Federal-Project/Data/June/MoneyTransferApps/Photos/" + picture_file
